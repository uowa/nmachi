...
| 28 | 動画数変更時に位置をリセット（videoAutoReset） | index.ejs / index.js | コメントアウト中。有効化時は index.ejs のチェックボックスのコメントアウトを外す。CLAUDE.md の localStorage キー一覧に `videoAutoReset` を追記すること |
